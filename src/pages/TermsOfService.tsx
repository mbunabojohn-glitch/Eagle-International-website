const TermsOfService = () => {
  return (
    <div className="container-custom py-20">
      <h1 className="font-heading text-4xl font-bold text-slate-800 dark:text-white mb-8">Terms of Service</h1>
      
      <div className="prose prose-invert max-w-4xl space-y-8 text-grey-light">
        <section>
          <h2 className="font-heading text-2xl font-bold text-blue-primary mb-4">1. Acceptance of Terms</h2>
        ...
        <section>
          <h2 className="font-heading text-2xl font-bold text-blue-primary mb-4">2. Description of Services</h2>
        ...
        <section>
          <h2 className="font-heading text-2xl font-bold text-blue-primary mb-4">3. User Responsibilities</h2>
        ...
        <section>
          <h2 className="font-heading text-2xl font-bold text-blue-primary mb-4">4. Intellectual Property</h2>
          <p className="leading-relaxed">
        ...
        <section>
          <h2 className="font-heading text-2xl font-bold text-blue-primary mb-4">5. Service Availability</h2>
          <p className="leading-relaxed">
        ...
        <section>
          <h2 className="font-heading text-2xl font-bold text-blue-primary mb-4">6. Limitation of Liability</h2>
          <p className="leading-relaxed mb-4">
        ...
        <section>
          <h2 className="font-heading text-2xl font-bold text-blue-primary mb-4">7. Confidentiality</h2>
          <p className="leading-relaxed">
        ...
        <section>
          <h2 className="font-heading text-2xl font-bold text-blue-primary mb-4">8. Governing Law</h2>
          <p className="leading-relaxed">
        ...
        <section>
          <h2 className="font-heading text-2xl font-bold text-blue-primary mb-4">9. Modifications to Terms</h2>
          <p className="leading-relaxed">
        ...
        <section>
          <h2 className="font-heading text-2xl font-bold text-blue-primary mb-4">10. Severability</h2>
          <p className="leading-relaxed">
        ...
        <section>
          <h2 className="font-heading text-2xl font-bold text-blue-primary mb-4">11. Contact Information</h2>
          <p className="leading-relaxed">
            If you have any questions about these Terms of Service, please contact us at:
          </p>
          <div className="mt-4 p-4 bg-light-secondary dark:bg-dark-secondary rounded-md border border-dark-tertiary">
            <p className="font-bold text-slate-800 dark:text-white">Eagle International Group LLC</p>
