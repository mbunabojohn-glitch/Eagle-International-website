const PrivacyPolicy = () => {
  return (
    <div className="container-custom py-20">
      <h1 className="font-heading text-4xl font-bold text-slate-800 dark:text-white mb-8">Privacy Policy</h1>
      
      <div className="prose prose-invert max-w-4xl space-y-8 text-grey-light">
        <section>
          <h2 className="font-heading text-2xl font-bold text-blue-primary mb-4">1. Information We Collect</h2>
        ...
        <section>
          <h2 className="font-heading text-2xl font-bold text-blue-primary mb-4">2. How We Use Your Information</h2>
        ...
        <section>
          <h2 className="font-heading text-2xl font-bold text-blue-primary mb-4">3. Information Sharing</h2>
          <p className="leading-relaxed">
        ...
        <section>
          <h2 className="font-heading text-2xl font-bold text-blue-primary mb-4">4. Data Security</h2>
          <p className="leading-relaxed">
        ...
        <section>
          <h2 className="font-heading text-2xl font-bold text-blue-primary mb-4">5. Cookies and Tracking</h2>
          <p className="leading-relaxed">
        ...
        <section>
          <h2 className="font-heading text-2xl font-bold text-blue-primary mb-4">6. Your Rights</h2>
        ...
        <section>
          <h2 className="font-heading text-2xl font-bold text-blue-primary mb-4">7. Third-Party Links</h2>
          <p className="leading-relaxed">
        ...
        <section>
          <h2 className="font-heading text-2xl font-bold text-blue-primary mb-4">8. Children's Privacy</h2>
          <p className="leading-relaxed">
        ...
        <section>
          <h2 className="font-heading text-2xl font-bold text-blue-primary mb-4">9. Changes to This Policy</h2>
          <p className="leading-relaxed">
        ...
        <section>
          <h2 className="font-heading text-2xl font-bold text-blue-primary mb-4">10. Contact Us</h2>
          <p className="leading-relaxed">
